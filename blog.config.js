...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '18a5659830fb45e099f2bf6323a37a13,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是LANNI, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LANNI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '这里是LANNIの小窝 科技和日常文章的分享区', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lanni.us.kg', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,lanni,LANNI666,hwafeng,suyutong,huabofeng,华博枫,lanniblog', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'email@huabofeng.eu.org', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/HuaBofeng', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/3493088609699876', // B站主页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '闽ICP备××××××××××号', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8902458817', // 对应歌单的 id
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || nqr1pwpt8z, // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
