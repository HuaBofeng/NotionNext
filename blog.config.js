...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '烂泥不太烂', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.lanni.us.kg', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, huabofeng, lanni, LANNI, 华博枫, 烂泥, suyutong, bofeng, blog', // 网站关键词 英文逗号隔开
